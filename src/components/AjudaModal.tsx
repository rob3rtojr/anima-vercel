        ...
        <Modal.Body>
            <div className='flex md:flex-row flex-col justify-between w-full gap-2'>
              ...
              <div className='flex flex-col'>
                ...
                <span className='text-justify'>Em caso de dúvidas ou dificuldades no login, pedimos que entre em contato pelo e-mail <span className='pt-4 text-blue-800'>edufin.estudantes@institutoanima.org.br</span> e nos informe a etapa que está acontecendo o erro, incluindo, se possível, um print da tela.</span>              
              </div>
              }
            </div>          
        </Modal.Body>
